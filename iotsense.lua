...
local Files = listfiles(string.format("%s/%s", "iotsense", tostring(game.PlaceId)))
...
Library:SetWatermark("iotsense")

local Window = Library:CreateWindow("iotsense")
...
local MainBOX = GeneralTab:AddLeftTabbox("Main") do
    ...
    Main:AddToggle("esp", function()
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/iotxv/iotsensescripts/main/esp.lua'),true))()
        boxesp(true)
    end)
    Main:AddToggle("chams", function()
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/iotxv/iotsensescripts/main/chams.lua'),true))()
    end)
    Main:AddToggle("skeleton", function()
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/iotxv/iotsensescripts/main/skeleton.lua'),true))()
    end)
    Main:AddToggle("item esp", function()
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/iotxv/iotsensescripts/main/itemesp.lua'),true))()
    end)
